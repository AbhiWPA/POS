...
//        return allItems;
        ...
        return (ArrayList<ItemDTO>) SQLUtil.executeQuery("SELECT * FROM Item");
    }
...
//        return pstm.executeUpdate() > 0;
        ...
        return SQLUtil.executeUpdate("INSERT INTO Item (code, description, unitPrice, qtyOnHand) VALUES (?,?,?,?)", dto.getDescription(), dto.getUnitPrice(), dto.getQtyOnHand(), dto.getCode());
    }
